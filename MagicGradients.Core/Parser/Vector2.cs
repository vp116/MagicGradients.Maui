...
{
    public static Vector2 Zero { get; } = new(0d, 0d);
    public static Vector2 Left { get; } = new(-1d, 0d);
    public static Vector2 Right { get; } = new(1d, 0d);
    public static Vector2 Up { get; } = new(0d, -1d);
    public static Vector2 Down { get; } = new(0d, 1d);
