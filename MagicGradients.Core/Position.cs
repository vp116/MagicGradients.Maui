...
public struct Position
{
    ...
    public static Position Prop(double x, double y)
    {
        return new Position(Offset.Prop(x), Offset.Prop(y));
    }

    public static Position Abs(double x, double y)
    {
        return new Position(Offset.Abs(x), Offset.Abs(y));
    }
