...
public static class MaskExtensions
{
    ...
    public static T Size<T>(this T mask, double width, double height, OffsetType type = OffsetType.Absolute)
        where T : RectangleMask
    {
    ...
    public static T Corners<T>(this T mask, double corners, OffsetType type = OffsetType.Absolute)
        where T : RectangleMask
    {
    ...
    public static T Corners<T>(this T mask, Dimensions? topLeft = null, Dimensions? topRight = null,
        Dimensions? bottomRight = null, Dimensions? bottomLeft = null) where T : RectangleMask
    {
    ...
    public static T Corners<T>(this T mask, double topLeft = 0, double topRight = 0, double bottomRight = 0,
        double bottomLeft = 0, OffsetType type = OffsetType.Absolute) where T : RectangleMask
    {
        mask.Corners = new Corners(
