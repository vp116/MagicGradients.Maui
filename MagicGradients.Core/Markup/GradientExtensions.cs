...
public static class GradientExtensions
{
    ...
    public static RadialGradient At(this RadialGradient gradient, double x, double y,
        OffsetType type = OffsetType.Proportional)
    {
    ...
    public static RadialGradient Size(this RadialGradient gradient, double width, double height,
