...
{
    public static bool IsClosest(this RadialGradientSize size)
    {
        return (int)size < 3;
    }

    public static bool IsFarthest(this RadialGradientSize size)
    {
        return (int)size >= 3;
    }

    public static bool IsCorner(this RadialGradientSize size)
    {
        return (int)size % 2 == 0;
    }

    public static bool IsSide(this RadialGradientSize size)
    {
        return (int)size % 2 != 0;
    }
}
