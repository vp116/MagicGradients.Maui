...
public struct Dimensions
{
    ...
    public static Dimensions Prop(double width, double height)
    {
        return new Dimensions(Offset.Prop(width), Offset.Prop(height));
    }

    public static Dimensions Abs(double width, double height)
    {
        return new Dimensions(Offset.Abs(width), Offset.Abs(height));
    }
